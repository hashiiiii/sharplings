...
| Collection expressions (C# 12) | expected — accepts ≤ 12 (Stage 1) | Working | untested | Yes — official | Exercised in `03_collections`. |
| Primary constructors (C# 12) | expected — accepts ≤ 12 (Stage 1) | Working | untested | Yes — official | Exercised in `01_records`. |
| Raw string literals (C# 11) | expected — accepts ≤ 12 (Stage 1) | Working | untested | Yes — official | Exercised in `04_strings`. |
